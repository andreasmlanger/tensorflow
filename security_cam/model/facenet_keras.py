...
def create_inception_resnet_v2():
	...
	up = Lambda(scaling, output_shape=backend.int_shape(up)[1:], arguments={'scale': 0.17})(up)
	x = add([x, up])
	...
	up = Lambda(scaling, output_shape=backend.int_shape(up)[1:], arguments={'scale': 0.1})(up)
	x = add([x, up])
	...
	up = Lambda(scaling, output_shape=backend.int_shape(up)[1:], arguments={'scale': 0.2})(up)
	x = add([x, up])
	...
	up = Lambda(scaling, output_shape=backend.int_shape(up)[1:], arguments={'scale': 1})(up)
	x = add([x, up])
